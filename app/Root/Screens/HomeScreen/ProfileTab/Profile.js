...
import {left, logout, avtar, profile, myactivity} from 'app/assets';
...
export default class Profile extends Component {
  ...
  render() {
    return (
      <Container>
        <MainHeader bodyContent={'Profile'} />
        <Content>
          <View style={{}}>
            <Block
              flex={false}
            ...
            <ListItem
              icon
              onPress={() =>
                this.props.navigation.navigate('MyActivityScreen')
              }>
              <Left>
                <Image source={myactivity} style={styles.iconStyle} />
              </Left>
              <Body>
